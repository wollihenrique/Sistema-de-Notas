    ...
    <div class="box-conteiner">
        <form action="#" method="post">
            <div class="note-title">
                ...
                <input class="note-text" type="text" name="title" placeholder="Type your note's title..." required>
            </div>
            <div class="note-content">
                <label for="text">Text</label>
                <textarea maxlength="200" class="note-text" name="text" placeholder="Type your note..." required></textarea>
            </div>
